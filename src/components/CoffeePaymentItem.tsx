...
export function CoffeePaymentItem(props: {
	...
	removeProductToCart: (name: string, amountSub: number) => void
}) {
	const formattedPrice = (
		props.coffeeData.price * props.coffeeData.amount
				...
				<div className="flex gap-2">
					<div className="flex gap-4 px-3 rounded-md bg-gray-100 text-amber-800">
						<p
							...
							onClick={() => {
								props.removeProductToCart(props.coffeeData.name, 1)
							}}
						>
							_
						</p>
						...
						<p
							...
							onClick={() => {
								props.addProductToCart(
									props.coffeeData.name,
									props.coffeeData.src,
									1,
									props.coffeeData.price,
								)
							}}
						>
							+
