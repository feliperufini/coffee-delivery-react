	...
	return (
		<div className="flex fixed justify-between px-4 py-10 overflow-hidden top-0 w-[90rem] bg-[#f1f1f1]">
			<Link to="/">
				<div className="flex">
					<img
						src="https://verdebuild.com/wp-content/uploads/Starbucks-Logo-PNG-Image.png"
						width={40}
					/>
			...
			<div className="flex gap-3">
				<button className="flex items-center h-[38px] gap-1 px-3 rounded-md font-normal bg-green-200 text-green-800 hover:bg-green-300">
