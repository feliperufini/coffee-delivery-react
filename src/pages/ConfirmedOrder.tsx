  ...
  return (
    <div className="grid grid-cols-2 gap-8 py-8">
      <div>
        ...
        <p className="text-xl mb-12">Agora é só aguardar que logo o café chegará até você</p>
        <div className="bg-gradient p-10 mb-4 rounded-tr-3xl rounded-bl-3xl rounded-tl-md rounded-br-md">
          <div className="flex gap-3 items-center mb-6">
            <MapPin size={32} weight="fill" className="p-1.5 rounded-full text-gray-100 bg-purple-700" />
            <div>
          ...
          <div className="flex gap-3 items-center mb-6">
            <Timer size={32} weight="fill" className="p-1.5 rounded-full text-gray-100 bg-yellow-500" />
            <div>
          ...
          <div className="flex gap-3 items-center">
            <CurrencyDollar size={32} weight="fill" className="p-1.5 rounded-full text-gray-100 bg-amber-800" />
            <div>
